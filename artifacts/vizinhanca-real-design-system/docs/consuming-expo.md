# Consuming Vizinhança Real Design System in Expo apps

Read `artifacts/vizinhanca-real-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/vizinhanca-real-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/vizinhanca-real-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/vizinhanca-real-design-system/lib/native-theme";
import { useColors } from "@workspace/vizinhanca-real-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/vizinhanca-real-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/vizinhanca-real-design-system/components/native/badge";
import { Button } from "@workspace/vizinhanca-real-design-system/components/native/button";
import { Card } from "@workspace/vizinhanca-real-design-system/components/native/card";
```
...
Import and render
`@workspace/vizinhanca-real-design-system/components/native/button`, then run Expo
