# Migrating Expo UI to Vizinhança Real Design System

Read `artifacts/vizinhanca-real-design-system/docs/AGENTS.md` and
`artifacts/vizinhanca-real-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/vizinhanca-real-design-system/lib/native-theme` and
  `@workspace/vizinhanca-real-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/vizinhanca-real-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/vizinhanca-real-design-system` and retains only
