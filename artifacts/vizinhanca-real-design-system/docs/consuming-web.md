# Consuming Vizinhança Real Design System in web apps

Read `artifacts/vizinhanca-real-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/vizinhanca-real-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/vizinhanca-real-design-system/styles.css";
```
...
`node_modules/@workspace/vizinhanca-real-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/vizinhanca-real-design-system/components/ui/button";
import { cn } from "@workspace/vizinhanca-real-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/vizinhanca-real-design-system/hooks/use-toast";
```
...
`@workspace/vizinhanca-real-design-system/components/ui/button`. Run the app's typecheck
