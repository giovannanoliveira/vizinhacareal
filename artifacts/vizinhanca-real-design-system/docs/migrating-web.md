# Migrating web UI to Vizinhança Real Design System

Read `artifacts/vizinhanca-real-design-system/docs/AGENTS.md` and
`artifacts/vizinhanca-real-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/vizinhanca-real-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/vizinhanca-real-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/vizinhanca-real-design-system/hooks/use-toast`
